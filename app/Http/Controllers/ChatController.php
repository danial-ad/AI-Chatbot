        ...
        $messages = [
            [
                ...
                'content' => "Please only answer based on the following context (If question is not relevance do not entertain!!!, do not answer any unrelated question): 
                    ...
                    ".$context."
                    ------------------------------------------
                   If a question is not relevant, kindly refrain from responding. Instead, provide the following response: 'Sorry, this question is outside my scope of answers, and I am unable to respond.
